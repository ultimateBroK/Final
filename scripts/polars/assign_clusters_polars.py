...
# -*- coding: utf-8 -*-
"""
BƯỚC 7: GÁN NHÃN CỤM CHO TỮNG GIAO DỊCH
...
Input:
  - data/processed/final_centroids.txt (5 tâm cụm từ bước 6)
...
print("="*70)
print("🏷️  BƯỚC 7: GÁN NHÃN CỤM CHO TỮNG GIAO DỊCH")
print("="*70)
print()

# ==================== ĐỌC TÂM CỤM CUỐI CÙNG ====================
print("🎯 ĐỌC TÂM CỤM CUỐI CÙNG TỪ BƯỚC 6...")

centroids_file = os.path.join(DATA_PROCESSED, 'final_centroids.txt')
...
print("   Chạy bước 8: python scripts/polars/analyze_polars.py")
print()
