...
# -*- coding: utf-8 -*-
"""
BƯỚC 8: PHÂN TÍCH KẾT QUẢ (CLUSTER ANALYSIS)
...
Input:
  - data/results/clustered_results.txt (từ bước 7)
  - data/raw/HI-Large_Trans.csv (file gốc)
...
print("="*70)
print("📊 BƯỚC 8: PHÂN TÍCH KẾT QUẢ")
print("="*70)
print()

# ==================== ĐỌC KẾT QUẢ PHÂN CỤM ====================
print("📂 ĐỌC KẾT QUẢ PHÂN CỤM TỪ BƯỚC 7...")
...
print("   Tất cả 8 bước đã chạy thành công.")
